const DocumentosPersonaService = require('../services/documentos_persona_documento_afiliacion.service');
const DocumentosRepository = require('../repositories/documentos_persona_documento_afiliacion.repository');
    ...
    async deleteDocumentoPersonaComprobanteDomicilio(req, res) {
        try {
            ...
            await EmailService.enviarCorreo(
                usuario.correo,
                "Documento rechazado",
                `Hola, lamentamos informarte que tu documento "Documento de afiliación" ha sido rechazado. Sube lo antes posible nuevamente tu documento, se habilitará solo ese campo en tu pestaña para que lo puedas subir.`
            );

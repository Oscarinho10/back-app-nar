    ...
    async deleteDocumentoPersonaComprobanteDomicilio(req, res) {
        try {
            ...
            await EmailService.enviarCorreo(
                usuario.correo,
                "Documento rechazado",
                `Hola, lamentamos informarte que tu documento "Constancia de situación fiscal" ha sido rechazado. Sube lo antes posible nuevamente tu documento, se habilitará solo ese campo en tu pestaña para que lo puedas subir.`
            );

const DocumentosPersonaService = require('../services/documentos_persona_caratula_banco.service');
const DocumentosRepository = require('../repositories/documentos_persona_caratula_banco.repository');
    ...
    async deleteDocumentoPersonaComprobanteDomicilio(req, res) {
        try {
            ...
            await EmailService.enviarCorreo(
                usuario.correo,
                "Documento rechazado",
                `Hola, lamentamos informarte que tu documento "Carátula de banco" ha sido rechazado. Sube lo antes posible nuevamente tu documento, se habilitará solo ese campo en tu pestaña para que lo puedas subir.`
            );
